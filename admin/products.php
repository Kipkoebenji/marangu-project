...
<body>
  <header class="admin-header"><div class="container"><div style="display:flex;justify-content:space-between;align-items:center">Products <div class="admin-nav"><a href="/admin/dashboard.php">Dashboard</a> <a href="/admin/product_form.php">Add product</a> <a href="/public/logout.php">Logout</a></div></div></div></header>
  <div class="container">
    <h2>Products</h2>
